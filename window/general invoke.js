...
Wait start milliseconds, then call f() every interval milliseconds, stopping after a total of start+end milliseconds.
...
function invoke(f,start,interval,end) {
    ...
    if (arguments.length <= 2) {   //Single-invocation case
        ...
        function repeat() {        //Invoked by the timeout above
            ...
            //Stop invoking after end ms, if end is defined
        }
    }
}  
